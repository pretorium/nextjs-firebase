...
import {
  GithubAuthProvider, signInWithPopup, getAuth,
} from 'firebase/auth';
...
export const authStateChanged = (setState) => new Promise((resolve, reject) => {
...
export const loginWithGithub = async () => {
  ...
  const auth = getAuth();
  const signIn = await signInWithPopup(auth, providerGithub);
  return signIn;
};
